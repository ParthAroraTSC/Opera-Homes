...
# Updated all image/pdf paths to 'assets/...'
                ...
                <div class="col-lg-6">
                    <div class="akshar-img-grid wow fadeInLeft">
                        <div class="akshar-img-main">
                            <img src="assets/images/about/WhatsApp-Image-2025-12-26-at-11.26.48-AM.png" alt="Opera Akshar">
                        ...
                        <div class="akshar-img-side">
                            <div class="akshar-img-top"><img src="assets/images/hero/View4Dusk.jpg" alt=""></div>
                            <div class="akshar-img-bottom"><img src="assets/images/hero/View1Dusk.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="akshar-content-new wow fadeInRight">
                        ...
                        <div class="akshar-btns">
                            ...
                            <a href="assets/pdf/Opera-Akshar-broucher.pdf" class="btn-akshar-outline" target="_blank">Download Brochure</a>
                        </div>
                    </div>
                </div>
            </div>
...
def main():
    ...
    tasks = [
        {
            'name': 'Update Akshar Section',
            'pattern': pattern,
            'replacement': new_section
        }
    ]
    
    processor.process_batch(tasks, target_files=['index.html'])
